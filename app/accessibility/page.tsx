...
export default function AccessibilityPage() {
  return <main className="page-shell content-page"><SiteHeader /><article className="legal-page">
    ...
    <section><h2>Bekannte Einschraenkungen</h2><p>Der externe Friendly-Captcha-Dienst kann je nach Hilfstechnologie, Netzwerk oder Einstellung zusaetzliche Huerden verursachen. Eingereichte Fotos werden in der Galerie nur dann sinnvoll beschrieben, wenn eine Bildbeschreibung vorliegt. Diese Punkte werden vor dem oeffentlichen Start mit Tastatur, Screenreader und unterschiedlichen Displaygroessen getestet.</p></section>
