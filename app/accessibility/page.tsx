...
export default function AccessibilityPage() {
  return <main className="page-shell content-page"><SiteHeader /><article id="inhalt" className="legal-page">
    ...
    <section><h2>Feedback und Kontakt</h2><p>Falls du auf eine Barriere stößt oder Informationen in einer anderen Form benötigst, schreibe an <a href={mailto(CONTACT_EMAIL)}>{CONTACT_EMAIL}</a>. Bitte beschreibe die Seite, das verwendete Gerät und den Browser, damit wir das Problem nachvollziehen können.</p></section>
