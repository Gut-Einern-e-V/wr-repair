import { moderatorManifest, manifestResponse } from "@/lib/app-manifests";

// Eigenes Manifest fuer die Moderation, siehe lib/app-manifests.ts.
...
export function GET() {
  return manifestResponse(moderatorManifest);
}
