...
export default function ModeratorDashboard({ email, roles }: { email: string; roles: Role[] }) {
  ...
  return (
    <main className="moderator-shell">
      ...
      <section className="moderator-intro"><p className="brand-kicker">Moderationsbereich</p><h1 className="sticker-head is-mint"><span className="sticker">Einreichungen</span><span className="sticker">im Blick</span></h1></section>
