export const messages = {
  de: {
    navigation: { stories: "Geschichten", project: "Projekt", supporters: "Unterstützung", lottery: "Gewinnspiel", live: "Live-Stand", submit: "Einreichen", festival: "Festival" },
  ...
  en: {
    navigation: { stories: "Stories", project: "Project", supporters: "Supporters", lottery: "Prize draw", live: "Live status", submit: "Submit", festival: "Festival" },
