...
-- 3. Die Partner standen schon immer nach `sort_order`, nur liess sich die
--    Spalte nirgends aendern. Gepflegt werden Partner ueber
--    /api/admin/partners und damit von Admins; die Richtlinie sagte bisher
--    Superadmin und widersprach der Route.
