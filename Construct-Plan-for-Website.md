...
- **Supabase** ist mit dem Projekt schon verknüpft und kann auf das GitHub-Projekt zugreifen, um die Datenbank und Storage zu verwalten. Die Supabase-Instanz ist bereits eingerichtet und kann für Authentifizierung, Datenbankoperationen und Storage genutzt werden. Also verwende das als livelink im Projekt, um die Einreichungen zu speichern und zu verwalten. Die Supabase-Instanz ist bereits mit dem GitHub-Repo verbunden, sodass Änderungen am Code automatisch in der Supabase-Instanz reflektiert werden können.
